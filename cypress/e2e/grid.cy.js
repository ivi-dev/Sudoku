describe('Grid operations', () => {
  ...
  describe('Pressing an arrow key', () => {
    it('moves the cell highlight up', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(4)')
        .click({ force: true })
      cy.get('body').trigger('keydown', { key: 'ArrowUp' })
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(4)')
        .should('not.have.class', 'active')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(1)')
        .should('have.class', 'active')
    })
    it('stopping at the grid\'s upper boundry', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(4)')
        .click({ force: true })
      cy.get('body').trigger('keydown', { key: 'ArrowUp' })
    ...
    it('moves the cell highlight down', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(1)')
        .click({ force: true })
    ...
    it('stopping at the grid\'s lower boundry', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:nth-of-type(7) .cell:nth-of-type(4)')
        .click({ force: true })
      cy.get('body').trigger('keydown', { key: 'ArrowDown' })
      cy.get('body').trigger('keydown', { key: 'ArrowDown' })
      cy.get('#grid .subgrid:nth-of-type(7) .cell:nth-of-type(4)')
        .should('not.have.class', 'active')
      cy.get('#grid .subgrid:nth-of-type(7) .cell:nth-of-type(7)')
        .should('have.class', 'active')
    })
    it('moves the cell highlight left', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(2)')
        .click({ force: true })
    ...
    it('stopping at the grid\'s left boundry', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(2)')
        .click({ force: true })
      cy.get('body').trigger('keydown', { key: 'ArrowLeft' })
    ...
    it('moves the cell highlight right', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:first-of-type .cell:nth-of-type(1)')
        .click({ force: true })
    ...
    it('stopping at the grid\'s right boundry', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid:nth-of-type(3) .cell:nth-of-type(2)')
        .click({ force: true })
      cy.get('body').trigger('keydown', { key: 'ArrowRight' })
      cy.get('body').trigger('keydown', { key: 'ArrowRight' })
      cy.get('#grid .subgrid:nth-of-type(3) .cell:nth-of-type(2)')
        .should('not.have.class', 'active')
      cy.get('#grid .subgrid:nth-of-type(3) .cell:nth-of-type(3)')
        .should('have.class', 'active')
    })
  })
  ...
  describe('Game completion', () => {
    ...
    it('The game\'s success notification disappears on starting a new game', () => {
      cy.visit('http://localhost:8080')
      cy.get('script#complete').then(grid => {
        const solution = JSON.parse(grid.text());
        const solutionMap = { 
        ...
        cy.get('.note.success').should('not.exist')
      })
    })
    ...
    it('The game\'s error notification disappears on starting a new game', () => {
      cy.visit('http://localhost:8080')
      cy.get('#grid .subgrid .cell').each(cell => {
        if (cell.text().trim() === '')
          cy.wrap(cell)
      ...
      cy.get('.start-new-game').click()
      cy.get('.prompt.new-game').find('button.yes').click()
      cy.get('.note.error').should('not.exist')
    })
  })
})